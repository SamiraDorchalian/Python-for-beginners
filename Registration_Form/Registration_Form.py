...
phoneEntry=Entry(root,textvariable=phoneValue,width=30,font=20, bd=2)
genderEntry=Entry(root,textvariable=genderValue,width=30,font=20, bd=2)
emailEntry=Entry(root,textvariable=emailValue,width=30,font=20, bd=2)
